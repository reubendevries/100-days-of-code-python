...
def payment(price, report):
    ...
    while not payment_completed:
        ...
        if total < price:
            ...
            print( f'You\'ve not put enough money in. Please put {amount_left} to cover the rest of the cost of the coffee' )
        else:
...
if __name__ == '__main__':
    while enough_ingredients:
        coffee_menu(report)
        if report['Coffee'] > 18 or report['Water'] > 50 or report['Milk'] > 0:
